...
//
//  Calibration tool. Upload this to the Arm 1 board, open the Serial Monitor
//  (115200), then:
//    1. Press and HOLD the unlock key on the Dobot arm.
//    2. Move the arm by hand to a target spot (e.g. the start point).
//    3. Send the letter 'P' from the Serial Monitor to capture the pose.
//    4. Paste the printed X/Y/Z/R into the matching const in arm1_feeder.cpp.
//  Re-flash the real firmware (arm1_feeder) when you are done.
// ============================================================================
